function [u,res,iter,R,T]= GaussSeidelPolarDirichlet(Nr,Nt,rorigin,rlast,torigin,tlast,itgmr,omega,tol)
        ...
        %A' calculation for delta formulation 
            ...
            for i=2:Nt+1
                for j=2:Nr+1   
                    ...
                    du(L) = omega*(1/ec)*(qrr(L)-hc*du(ie)-bc*du(iw)-fc*du(in)-dc*du(is)) + (1-omega)*du(L);
