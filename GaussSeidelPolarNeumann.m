function [u,res,iter,R,T]= GaussSeidelPolarNeumann(Nr,Nt,rorigin,rlast,torigin,tlast,itgmr,omega,tol)
           ...
           for i=2:Nt+1
                for j=2:Nr+1
                    ...
                    elseif j==Nr+1
                        ...
                        qrr(L) = -(c_i*u(L)+c_is*u(is)+c_iss*u(iss)+rhs(L));
                    ...
                    elseif i==Nt+1 & j ~= 2 & j ~= Nr+1 
                        ...
                        qrr(L) = -(hc*u(ie)+bc*u(iw)+fc*u(in)+dc*u(is)  ... 
                            +ec*u(L)+rhs(L));
        ...
        %A' calculation for delta formulation 
            ...
            for i=2:Nt+1
                for j=2:Nr+1   
                    ...
                    du(L) = omega*(1/ec)*(qrr(L)-hc*du(ie)-bc*du(iw)-fc*du(in)-dc*du(is))...
                        + (1-omega)*du(L);
